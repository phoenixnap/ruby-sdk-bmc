  ...
  class ServerPatch
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BmcApi::ServerPatch` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if !@hostname.nil? && @hostname.to_s.length > 100
    ...
    def valid?
      ...
      return false if !@hostname.nil? && @hostname !~ Regexp.new(/[a-zA-Z0-9().-]+/)
      true
    end
