  ...
  class ServerReset
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BmcApi::ServerReset` initialize method"
      end
    ...
    def hash
      [install_default_ssh_keys, ssh_keys, ssh_key_ids, os_configuration].hash
    end
