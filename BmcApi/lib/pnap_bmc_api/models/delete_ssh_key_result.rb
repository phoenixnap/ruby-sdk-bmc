  ...
  class DeleteSshKeyResult
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BmcApi::DeleteSshKeyResult` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @ssh_key_id.nil?
        invalid_properties.push('invalid value for "ssh_key_id", ssh_key_id cannot be nil.')
      end
