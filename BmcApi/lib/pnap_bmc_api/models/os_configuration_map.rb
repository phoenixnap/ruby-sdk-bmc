  ...
  class OsConfigurationMap
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BmcApi::OsConfigurationMap` initialize method"
      end
      ...
      if attributes.key?(:'proxmox')
        self.proxmox = attributes[:'proxmox']
      end
    end
