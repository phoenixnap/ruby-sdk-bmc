...
# Unit tests for NetworkApi::BgpIPv4Prefix
...
describe NetworkApi::BgpIPv4Prefix do
  ...
  describe 'test an instance of BgpIPv4Prefix' do
    it 'should create an instance of BgpIPv4Prefix' do
      ...
      #expect(instance).to be_instance_of(NetworkApi::BgpIPv4Prefix)
    end
  end

  describe 'test attribute "ipv4_allocation_id"' do
    it 'should work' do
  ...
  describe 'test attribute "is_bring_your_own_ip"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
