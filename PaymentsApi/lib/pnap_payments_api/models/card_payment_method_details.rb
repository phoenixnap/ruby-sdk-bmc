  ...
  class CardPaymentMethodDetails
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PaymentsApi::CardPaymentMethodDetails` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @last_four_digits !~ pattern
        invalid_properties.push("invalid value for \"last_four_digits\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if @last_four_digits !~ Regexp.new(/\d{4}$/)
      true
    end
    ...
    def last_four_digits=(last_four_digits)
      ...
      pattern = Regexp.new(/\d{4}$/)
      if last_four_digits !~ pattern
        fail ArgumentError, "invalid value for \"last_four_digits\", must conform to the pattern #{pattern}."
      end
    ...
    def hash
      [card_type, last_four_digits].hash
    end
