...
# Unit tests for BillingApi::ProductAvailability
...
describe BillingApi::ProductAvailability do
  ...
  describe 'test an instance of ProductAvailability' do
    it 'should create an instance of ProductAvailability' do
      ...
      #expect(instance).to be_instance_of(BillingApi::ProductAvailability)
    end
  end
  ...
  describe 'test attribute "location_availability_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
