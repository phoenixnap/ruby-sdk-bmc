  ...
  class ProductCategory
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LocationApi::ProductCategory` initialize method"
      end
      ...
      if attributes.key?(:'product_category_description')
        self.product_category_description = attributes[:'product_category_description']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          product_category_description == o.product_category_description
    end
    ...
    def hash
      [product_category, product_category_description].hash
    end
