  ...
  class Location
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LocationApi::Location` initialize method"
      end
      ...
      if attributes.key?(:'product_categories')
        if (value = attributes[:'product_categories']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          product_categories == o.product_categories
    end
    ...
    def hash
      [location, location_description, product_categories].hash
    end
