...
# Unit tests for AuditApi::ApiAction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AuditApi::ApiAction do
  let(:instance) { AuditApi::ApiAction.new }

  describe 'test an instance of ApiAction' do
    it 'should create an instance of ApiAction' do
      expect(instance).to be_instance_of(AuditApi::ApiAction)
    end
  end
