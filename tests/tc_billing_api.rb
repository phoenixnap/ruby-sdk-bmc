...
class TC_BillingApi < Test::Unit::TestCase
  ...
  def test_get_products
    ...
    #     "price": 1,
    #     "price_unit": "HOUR",
    #     "correlated_product_code": "d1.tiny",
    #     "package_quantity": 1,
    #     "package_unit": "GB"
    #   ]
    # }

    # x = BillingApi::ProductsGet200ResponseInner.build(data)
    # puts "class: #{x.class}"


    result = api_instance.products_get(opts)
    puts "test_get_products result: #{result}"
    assert_equal response[:body], [result[0].to_hash.compact]
  ...
  #   puts "test_get_rated_usage result: #{result}"
  #   assert_equal response[:body], [result[0].to_hash.compact]
  #
  #   self.verify_called_once expectation
  # end
  ...
  #   puts "test_get_rated_usage_month_to_date result: #{result}"
  #   assert_equal response[:body], [result[0].to_hash.compact]
  #
  #   self.verify_called_once expectation
  # end
