...
# Unit tests for BillingAPI::ReservationAutoRenewDisableRequest
...
describe BillingAPI::ReservationAutoRenewDisableRequest do
  ...
  describe 'test an instance of ReservationAutoRenewDisableRequest' do
    it 'should create an instance of ReservationAutoRenewDisableRequest' do
      ...
      #expect(instance).to be_instance_of(BillingAPI::ReservationAutoRenewDisableRequest)
    end
  end

  describe 'test attribute "auto_renew_disable_reason"' do
    it 'should work' do
